                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="userForm" modelAttribute="reportForm"  enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/report/update/"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-1 col-sm-6 col-xs-12">
                                            <form:select path="type" required="required" data-validate-minmax="10,100"
                                                ...
                                                <c:if test="${reportForm.type ==1}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">REPORT</form:option>
                                                </c:if>
                                                <c:if test="${reportForm.type ==2}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">REPORT</form:option>
                                                </c:if>
                                                <c:if test="${reportForm.type ==3}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">REPORT</form:option>
                                                </c:if>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <%--<c:forEach items="${reportForm.picUrl1}" var="url1">--%>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <form:input path="picFile2" id="picFile2"
                                                        ...
                                                        required="" type="file" multiple="multiple"/>
                                            <%--<c:forEach items="${reportForm.picUrl2}" var="url1">--%>
                                                <%--<div><img src="${url1}" class='file-preview-image kv-preview-data  col-md-2 col-sm-1 col-xs-12'--%>
                                                          <%--style='width:20%;height:20%;max-width:100%;max-height:100%;margin-bottom: 20px;' alt='' title=''></div>--%>
                                            <%--</c:forEach>--%>
                                        </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">詳細1 <span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="detail" id="detail"  required="" name="detail" type="hidden"
                                                     ...
                                                     value="${reportForm.detail}"></form:input>
                                        <div class="x_content">
                                            <div id="alerts"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <form:input type="hidden" path="id" value="${reportForm.id}"/>
                                    <form:input type="hidden" path="picUrl1" value="${reportForm.picUrl1}"/>
                                    <form:input type="hidden" path="picUrl2" value="${reportForm.picUrl2}"/>
...
<script>
    ...
    $('#picFile2').fileinput({
        ...
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${reportForm.picUrl2}" var="url2">
