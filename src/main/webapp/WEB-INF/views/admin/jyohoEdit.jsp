                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="userForm" modelAttribute="newsForm"  enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/jyoho/update/"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-1 col-sm-6 col-xs-12">
                                            <form:select path="type" required="required" data-validate-minmax="10,100"
                                                ...
                                                <c:if test="${newsForm.type ==1}">
                                                    <form:option value="1">観光</form:option>
                                                    <form:option value="2">健康</form:option>
                                                    <form:option value="3">番組情報</form:option>
                                                </c:if>
                                                <c:if test="${newsForm.type ==2}">
                                                    <form:option value="1">観光</form:option>
                                                    <form:option value="2">健康</form:option>
                                                    <form:option value="3">番組情報</form:option>
                                                </c:if>
                                                <c:if test="${newsForm.type ==3}">
                                                    <form:option value="1">観光</form:option>
                                                    <form:option value="2">健康</form:option>
                                                    <form:option value="3">番組情報</form:option>
                                                </c:if>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <form:input path="picFile2" id="picFile2"
                                                        ...
                                                        required="" type="file" multiple="multiple"/>
                                            <%--<c:forEach items="${newsForm.picUrl2}" var="url1">--%>
                                                <%--<div><img src="${url1}" class='file-preview-image kv-preview-data  col-md-2 col-sm-1 col-xs-12'--%>
                                                          <%--style='width:20%;height:20%;max-width:100%;max-height:100%;margin-bottom: 20px;' alt='' title=''></div>--%>
                                            <%--</c:forEach>--%>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-primary" href="/admin/jyoho/list/" style="width: 100px;">キャンセル</a>
                                    <form:input type="hidden" path="id" value="${newsForm.id}"/>
                                    <form:input type="hidden" path="picUrl1" value="${newsForm.picUrl1}"/>
                                    <form:input type="hidden" path="picUrl2" value="${newsForm.picUrl2}"/>
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        <c:if test="${newsForm.picUrl1 != null && newsForm.picUrl1 != ''}">
    ...
    $('#picFile2').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove':false,'dropZoneTitle':'', 'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":500,"maxImageWidth":500,"minImageHeight":500,"maxImageHeight":500
        <c:if test="${newsForm.picUrl2 != null && newsForm.picUrl2 != ''}">
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${newsForm.picUrl2}" var="url2">
