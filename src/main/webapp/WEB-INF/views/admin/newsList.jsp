                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/news/regist/"
                                    ...
                                    <div class="col-md-11">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                            ...
                                            <select class="form-control has-feedback-left" id="type" style="-webkit-appearance: none; padding-left: 45px;">
                                                ...
                                                <option value="1">nihao</option>
                                                <option value="2">nihao</option>
...
<script>
    ...
    function gotoUpdate(id) {
        $('#newsLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/news/edit/' + id + '/';
    }
