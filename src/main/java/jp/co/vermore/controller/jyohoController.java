 ...
 */
@Controller
public class jyohoController extends BaseController {
    ...
    @RequestMapping(value = "/api/jyoho/list/{type}/{limit}/{offset}/", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/api/jyoho/list/{type1}/{type2}/{limit}/{offset}/", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/api/jyoho/detail/{uuid}/", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/sns/jyohoDetail/{uuid}/", method = RequestMethod.GET)
    public Object getNewsSNSDetail(@PathVariable String uuid, Model model, HttpServletRequest hsr) {
        ...
        if(newsDetailList.size()>0){
            ...
            model.addAttribute("url", "https://www.japanmoveupwest.com" + "/jyohoDetail/" + news.getUuid() + "/");
        ...
        if (m.find()) {
            ...
            logger.debug("-------tourl");
            return "redirect:"+ hosturl + "/jyohoDetail/" + uuid + "/";
        }
    }

    // News detail for sns
    //eg:http://localhost:8081/moveup_war/api/sns/newsDetail/app/4hIZRgPJFu/
    @RequestMapping(value = "/api/sns/jyohoDetail/app/{uuid}/", method = RequestMethod.GET)
    @ResponseBody
    public JsonObject getNewsDetailSNSForApp(@PathVariable String uuid) {

        Map<String, Object> urlMap = new HashMap<String, Object>();
        urlMap.put("twitter","https://twitter.com/share?url="+hosturl+"/jyohoDetail/"+uuid+"/");
        urlMap.put("facebook","https://www.facebook.com/sharer/sharer.php?u="+hosturl+"/jyohoDetail/"+uuid+"/");
