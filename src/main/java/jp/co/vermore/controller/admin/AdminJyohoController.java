 ...
 */
@Controller
public class AdminJyohoController extends BaseController {
    ...
    @RequestMapping(value = "/admin/jyoho/list/", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/admin/jyoho/list/", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/admin/jyoho/regist/", method = RequestMethod.GET)
    public String newsInsert(Model model) {
        NewsForm form = new NewsForm();
        model.addAttribute("newsForm", form);
        return "admin/jyohoRegist";
    }

    @RequestMapping(value = "/admin/jyoho/regist/", method = RequestMethod.POST)
    public String newsInsert(@ModelAttribute NewsForm form ,HttpServletRequest request) {
        ...
        return "redirect:/admin/jyoho/list/";
    }

    @RequestMapping(value = "/admin/jyoho/delete/", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/admin/jyoho/edit/{id}/", method = RequestMethod.GET)
...
//            newsForm.setDate(date.replace(" ", "T"));
            ...
            return "admin/jyohoEdit";

        }else {
            return "redirect:/admin/joyho/list/";
        }
    }

    @RequestMapping(value = "/admin/jyoho/update/", method = RequestMethod.POST)
